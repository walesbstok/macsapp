...
object SeedDataProvider {
    ...
    fun getInitialMeetings(): List<MeetingEntity> = listOf(
        ...
        MeetingEntity(
            ...
            contentMarkdown = "Omówiono doświadczenia kliniczne ze stentami Allium w trudnych zwężeniach moczowodów. Prof. Grabowski potwierdził kwalifikację dwóch pacjentów do implantac[...]",
